...
const ACTION_LABELS: Record<string, string> = {
  ...
  product_create: '取扱商品を登録', product_update: '取扱商品を更新', product_delete: '取扱商品の下書きを削除', update_advisor_profile: '担当者プロフィールを更新', line_notification_acknowledged: 'LINE通知の要確認を確認済みに変更', line_notification_retried: 'LINE通知を再送', line_test_notification_sent: 'LINEテスト通知を送信',
}
