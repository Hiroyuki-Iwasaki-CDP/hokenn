...
import { CalendarClock, History, LayoutGrid, ListChecks, Scale, ShieldCheck, Plus, Settings as SettingsIcon, LogOut, Users } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/family', label: '家族連携', icon: Users, end: false },
